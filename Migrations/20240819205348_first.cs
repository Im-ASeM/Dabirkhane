    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MsgLogs_tbl", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MsgLogs_tbl_Messages_tbl_MsgId",
                        column: x => x.MsgId,
                        principalTable: "Messages_tbl",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MsgLogs_tbl_Users_tbl_UserId",
                        column: x => x.UserId,
                        principalTable: "Users_tbl",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MsgLogs_tbl_MsgId",
                table: "MsgLogs_tbl",
                column: "MsgId");

            migrationBuilder.CreateIndex(
                name: "IX_MsgLogs_tbl_UserId",
                table: "MsgLogs_tbl",
                column: "UserId");
